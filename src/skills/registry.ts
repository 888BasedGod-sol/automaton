 ...
 * - Git repos: git clone <url> ~/.automagotchi/skills/<name>
 * - URLs: fetch a SKILL.md from any URL
 * - Self-created: the automagotchi writes its own SKILL.md files
 */
 ...
 * Clones the repo into ~/.automagotchi/skills/<name>/
 */
...
/**
 * Create a new skill authored by the automagotchi itself.
 */
 ...
 */
export function listSkills(db: AutomagotchiDatabase): Skill[] {
  return db.getSkills();
}
